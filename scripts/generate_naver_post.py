...
2. 소제목은 이모지+명사형 (예: "🛒 상품명 — 가격의 특징")
3. 쿠팡 링크는 소제목 섹션 본문 설명 2~3줄 후에 반드시 삽입
   형식: "지금 쿠팡에서 확인하기 → [링크URL]"
4. 해시태그는 6~12개, 마지막 줄에만
...
③ 구매 배경 스토리 (2~3줄)
④ 결론 먼저: "결론부터 말하면," (1~2줄)
⑤ 상품1: 🛒 소제목 → 본문 2~3줄 → 쿠팡링크
⑥ 상품2: 🛒 소제목 → 본문 2~3줄 → 쿠팡링크
⑦ (상품3 있으면 동일)
⑧ ✅ 선택 가이드 소제목 → 비교 정리 3~5줄
⑨ 마무리 + 공감/댓글 유도
⑩ 해시태그

[분량] 1,800~2,500자
[문체] 대화체 (~요, ~네요, ~더라고요), 솔직한 장단점 포함
[제목] 25~38자, 이모지 없이 순수 텍스트, 가격/경험담형

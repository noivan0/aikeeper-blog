...
【이미지 밀도】 244자마다 쿠팡 링크 1개 삽입 (= 이미지+OG카드 트리거)
【제목】 28~42자 (중앙값 34자)
【해시태그】 4~8개, 마지막 줄에

【오프닝 유형 — 3가지 중 선택】
A) 상황 서술형: "약 5년 쓰던 청소기가 망가졌다. 갑자기 사려니 돈이 아까운 ㅋㅋ"
B) 공감질문형: "여러분은 키친타월 어떻게 고르세요?"
C) 주제 선언형: "오늘은 쿠팡에서 구매한 ○○ 내돈내산 후기입니다"
...
3. 쿠팡 링크: 상품 소개 본문 150~250자 직후 반드시 삽입
   형식: "지금 쿠팡에서 확인하기 → [링크URL]"
4. 단점 1개 이상 필수 (없으면 신뢰도 0)
5. 가격 구체적으로 (구입가 직접 명시)
6. 파트너스 고지: 첫 줄 고정
